...
call s:hi("StatusLine", "NONE", s:base, s:peach, "NONE", "NONE")
call s:hi("StatusLineNC", "NONE", s:base, s:lavender, "NONE", "NONE")
call s:hi("StatusLineTerm", "NONE", s:base, s:red, "NONE", "NONE")
call s:hi("StatusLineTermNC", "NONE", s:base, s:lavender, "NONE", "NONE")
