...
call s:hi("StatusLine", "NONE", s:crust, s:peach, "NONE", "NONE")
call s:hi("StatusLineNC", "NONE", s:crust, s:lavender, "NONE", "NONE")
call s:hi("StatusLineTerm", "NONE", s:crust, s:red, "NONE", "NONE")
call s:hi("StatusLineTermNC", "NONE", s:crust, s:lavender, "NONE", "NONE")
