...
let g:colors_name='mocha_custom'
set t_Co=256
...
call s:hi("StatusLine", "NONE", s:mantle, s:text, "NONE", "NONE")
call s:hi("StatusLineNC", "NONE", s:text, s:surface1, "NONE", "NONE")
call s:hi("StatusLineTerm", "NONE", s:mantle, s:text, "NONE", "NONE")
call s:hi("StatusLineTermNC", "NONE", s:text, s:surface1, "NONE", "NONE")
